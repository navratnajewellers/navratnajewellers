                      ...
                      <Accordion.Panel header="DESCRIPTION" eventKey={2}>
                        <div className="margin-t20 margin-b20">
                          <h4 className="margin-b10">
                            1 gram 24 Karat Gold Coin
                          </h4>
                          <Text>
                            This 24 Karat Navratna gold coin is the perfect
                            investment for you. The tail also features the gold
                            purity and the weight of the coin. With a plain rim,
                            the coin highlights a serrated pattern along its
                            edge. The high-polished finish adds a lustrous
                            appeal to the coin.
                          </Text>
                        </div>
                      </Accordion.Panel>
